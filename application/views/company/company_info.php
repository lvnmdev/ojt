			...
			<div class="card-content">
				...
				<div class='card-body'>
					<div class="row">
						...
						<p id='company_desc' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
					<div class="row">
						<p class='col-xs-12 col-sm-3 col-md-2'>
							<strong>HR Manager:</strong>
						</p>
						<p id='company_hr' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
					<div class="row">
						<p class='col-xs-12 col-sm-3 col-md-2'>
							<strong>Contact No:</strong>
						</p>
						<p id='company_contact' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
					<div class="row">
						<p class='col-xs-12 col-sm-3 col-md-2'>
							<strong>Company TIN(BIR):</strong>
						</p>
						<p id='company_tin' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
					<div class="row">
						<p class='col-xs-12 col-sm-3 col-md-2'>
					...
					<div class="row">
						...
						<p id='company_opdate' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
					<div class="row">
						<p class='col-xs-12 col-sm-3 col-md-2'>
							<strong>Street:</strong>
						</p>
						<p id='company_street' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
					<div class="row">
						<p class='col-xs-12 col-sm-3 col-md-2'>
							<strong>Barangay:</strong>
						</p>
						<p id='company_barangay' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
					<div class="row">
						<p class='col-xs-12 col-sm-3 col-md-2'>
							<strong>Postal Code:</strong>
						</p>
						<p id='company_postal' class='col-xs-12 col-sm-9 col-md-10'></p>
					</div>
				</div>
				<div class='card-footer'>
					<div class="row">
						<a id="btnedit_info" type="button" class="btn btn-success">
							<i class='fa fa-edit btn-icon'></i>Edit Company Info</a>
					</div>
				</div>
			</div>
		</div>
